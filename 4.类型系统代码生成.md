...
// Cross Module References
    // UMyClass类的UClass构造器，不注册
    HELLO_API UClass* Z_Construct_UClass_UMyClass_NoRegister();
    // UMyClass类的UClass构造器，注册
    HELLO_API UClass* Z_Construct_UClass_UMyClass();
    // UObject类的UClass构造器
    COREUOBJECT_API UClass* Z_Construct_UClass_UObject();
    UPackage* Z_Construct_UPackage__Script_Hello(); //这个宏的实现在Hello.init.gen.cpp里
...
关键点在于IMPLEMENT_CLASS_NO_AUTO_REGISTRATION宏，和上文MyClass.generated.h中的DECLARE_CLASS对应，
对照着定义IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMyClass)
